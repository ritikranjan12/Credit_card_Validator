...
__all__ = [ 'FONTSTRIKETHROUGH', 'OLE_XSIZE_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_HIMETRIC',
           'LoadPictureConstants', 'FONTITALIC', 'Default', 'Gray',
           'StdPicture', 'OLE_ENABLEDEFAULTBOOL', 'Color',
           'FONTUNDERSCORE', 'IFont', 'OLE_HANDLE', 'Picture',
           'Monochrome', 'FONTSIZE', 'StdFont', 'OLE_TRISTATE',
           'OLE_XSIZE_PIXELS', 'OLE_CANCELBOOL', 'Font',
           'OLE_YPOS_CONTAINER', 'IFontDisp', 'OLE_COLOR',
           'FontEvents', 'OLE_YPOS_PIXELS', 'FONTNAME',
           'IFontEventsDisp', 'OLE_XPOS_PIXELS', 'IPictureDisp',
           'Checked', 'OLE_YSIZE_PIXELS', 'OLE_YSIZE_HIMETRIC',
           'OLE_YPOS_HIMETRIC', 'FONTBOLD', 'IPicture',
           'OLE_XPOS_CONTAINER', 'OLE_YSIZE_CONTAINER', 'Unchecked',
           'VgaColor', 'OLE_OPTEXCLUSIVE']
